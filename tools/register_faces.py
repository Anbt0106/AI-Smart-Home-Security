...
from src.reid.reid_model import FaceRec

if __name__ == "__main__":
    print("[INFO] Starting face registration...")

    base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    encodings_path = os.path.join(base_dir, "data", "assets", "encodings.pickle")
    dataset_path = os.path.join(base_dir, "data", "assets", "faces")
